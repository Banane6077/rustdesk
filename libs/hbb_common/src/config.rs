...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("CD-Fernwartung".to_owned()));
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["deskix.colordruck.net"];
pub const PUBLIC_RS_PUB_KEY: &str = "gg1AFMZVzSMWTAJ+2V5dFZRLkZbiZGmTh8O7vn2lTWk=";
